...
//n열까지의 더 큰 값을 고르기 위해 고려해야하는 행위를 식으로 표현하자(지그재그 합 vs 한칸 떨어진 대각선 합)
...
//        }
        ...
        //두번째 열 부터 점화식을 적용해야한다. 바로 1열 -> 3열 대각선 합이 지그재그 합보다 더 큰 경우가 존재할 수 있기 때문
//        dp[1][2] = dp[2][1] + arr[1][2]
//        dp[2][2] = dp[1][2] + arr[2][2]
        ...
        for(i in 2..N) {
            ...
            //둘 중에 값이 큰 것이 해당 열까지의 최댓값 x -> 영향을 준다라는 것이 너무 모호
